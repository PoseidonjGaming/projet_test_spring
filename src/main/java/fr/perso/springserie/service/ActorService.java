...
public class ActorService extends BaseService<Actor, ActorDTO> implements IActorService {
    protected ActorService(IActorRepo repository, MapService mapService, IMapper<Actor, ActorDTO> customMapper) {
        super(repository, ActorDTO.class, Actor.class, mapService, customMapper);
    }
}
